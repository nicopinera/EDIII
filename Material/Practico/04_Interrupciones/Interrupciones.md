...
No necesariamente entra al _handler_ en ese mismo instante, porque puede estar atendiendo otra IRQ de mayor prioridad o porque está deshabilitada.
...
2. El procesador entra al _handler_ (ISR).
3. Apenas entra, el NVIC borra el estado _pendiente_ y lo pasa a **activo** (está ejecutando).
...
- El procesador atiende el _handler_.
