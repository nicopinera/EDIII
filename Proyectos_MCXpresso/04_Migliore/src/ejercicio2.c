 ...
 * en el display, realizar un programa que muestre indefinidamente la cuenta de
 * 0 a 9 en dicho display.
 *
 * */
...
int main2(void) {
  configuracionGPIO2();
  int i = 0;
  const uint32_t numDisplay[10] = {0x3F, 0x06, 0x5B, 0x4F, 0x66,
