/* Desarrolle un programa que configure un Timer para hacer parpadear un LED cada 1 segundo,
 utilizando la función de Match para alternar el estado del pin de salida.
 Condiciones:
