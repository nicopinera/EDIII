/* Escriba un programa que utilice el SysTick para gestionar dos tareas con
diferentes periodos de tiempo. • Tareas: o Un LED debe parpadear cada 500 ms. o
...
Puertos_t puert[] = {
    {0, 1, FUNC_0, OUTPUT}, {0, 2, FUNC_0, OUTPUT},  {0, 3, FUNC_0, OUTPUT},
    {0, 4, FUNC_0, OUTPUT}, {0, 22, FUNC_0, OUTPUT}, // se prende por bajo
};
