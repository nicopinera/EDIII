/* Escriba un programa que utilice una interrupción externa (EINT1) para
 incrementar un contador binario de 4 bits que se muestra en 4 LEDs. El contador
 debe resetearse a cero automáticamente cada 2 segundos, utilizando el SysTick.
