/* 5. Escriba un programa que identifique la presión de un pulsador conectado a
 * un pin GPIO configurado como entrada. Utiliza otro pin de salida para
 * encender un LED solo mientras el botón está presionado.
 */
#ifdef __USE_CMSIS
#include "LPC17xx.h"
#endif
