/* Escriba un programa que realice un promedio móvil con los últimos 8 datos
 * leídos del puerto 0. Entrada: Los 8 bits menos significativos del Puerto 0,
 * leídos cada cierto tiempo (usando un delay). Salida: El resultado del
 * promedio, también de 8 bits, debe mostrarse en los 8 pines más bajos del
 * Puerto 2. Consideración: Un promedio móvil se calcula sumando los últimos n
 * valores y dividiendo por n. En este caso, n=8.
 */
