 ...
 *	por el P0.22 tiene que prender el tiempo determinado del PWM segun el
 *numero N f=20hz
 *
 *	PWM - modulacion por ancho de pulso, cambias el tiempo en alto de un
 *pulso rectangular manteniendo la frecuencia fija. va del 0 al 100
 * */
#ifdef __USE_CMSIS
#include "LPC17xx.h"
#endif
